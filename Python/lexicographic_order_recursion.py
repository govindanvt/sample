...
def get_nxt_permu(seq):
    #Return next greater lexicographic permutation. Return None if cannot.7
    ...
    if nxt is None:
        ...
        # if cannot find q, then seq is the highest pwemutation
        if q == len(seq):
            return None
